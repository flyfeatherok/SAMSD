...
def parse_args():
    ...
    parser.add_argument('--dataset_type', type=str, default='CelebA', help='dataset_type')
    parser.add_argument('--dataset_img_type', type=str, default='jpg', help='dataset_image_type')
    parser.add_argument('--dataset_path', type=str, default='./CelebA/', help='dataset_path')
    parser.add_argument('--label_size', type=int, default=9, help='label_size')
    ...
    parser.add_argument('--CelebaA_attrs', type=str, nargs='+', help='selected attributes for the samples',
                        default=['Male', 'Smiling', 'Brown_Hair','Eyeglasses','Young'])
